    ...
    <section  className="bg-white dark:bg-black text-black dark:text-white min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center md:justify-between px-5 lg:px-14 gap-8 pt-5 md:pt-0 transition-colors duration-300">
      <div className="lg:w-1/2 w-full text-center lg:text-left">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center gap-3">
          ...
          <button className="bg-orange-500 hover:bg-orange-600 transition text-white font-semibold rounded-full px-6 py-2">Find Food</button>
        </div>
      </div>

      <div className="lg:w-1/2 w-full relative flex justify-center md-10 lg:mb-0">
        <div className="relative">
          <img src={img} alt="delivery guy" className="rounded-full w-[350px] h-[350px] md:w-[400px] md:h-[400px] object-cover " />
        </div>
